# ──────────────────────────────────────────────────────────────
#  build_bd_hdmi_gcm_ping_pong.tcl  –  HDMI round scaffold for PYNQ Z2.
#
#  Usage (Vivado Tcl console):
#    open_project AES_VERILOG.xpr
#    source pynq/build_bd_hdmi_gcm_ping_pong.tcl
#
#  Current revision status:
#    - Builds isolated AES + ping-pong baseline under a new BD name.
#    - HDMI RX/TX insertion points are intentionally preserved as TODO markers.
# ──────────────────────────────────────────────────────────────
...
set BD_NAME    "hdmi_gcm_ping_pong"

puts "INFO: HDMI scaffold script active (BD=${BD_NAME})"
puts "WARNING: HDMI RX/TX IP blocks are not yet wired in this revision."
...
# TODO:HDMI
# Add HDMI RX/TX subsystem blocks here once final IP set and board constraints
# are selected for this round. Keep clock/reset isolation explicit.
