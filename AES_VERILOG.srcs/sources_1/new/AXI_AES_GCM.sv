`timescale 1ns / 1ps
//////////////////////////////////////////////////////////////////////////////////
// AXI4-Lite slave wrapper for AES-256 GCM mode on PYNQ-Z2.
//
// Register map (32-bit words):
//   Addr   Name          R/W   Description
//   0x00   CTRL          W     [0] push_pt        (accept one PT block if pt_ready)
...
//                                [14]   pt_drop_sticky        (push_pt when not ready)
...
module AXI_AES_GCM #(
    ...
    GcmMode gm(
        ...
        .pt_data_i(pt_data_reg),
        .pt_valid_i(pt_valid_pulse),
        .pt_last_i(pt_last_pulse),
        .pt_ready_o(pt_ready),
        .ct_data_o(ct_data),
        .ct_valid_o(ct_valid),
        .ct_last_o(ct_last),
